...
def main():
    ...
    if(robot == 0):
        ...
        if(cond == 0):
            ...
            if(trust == 0):    
                sock.send("Speak Please take over. The front right sensor is malfunctioning based on the test code.\n")
            else:
                sock.send("Speak Please take over. The front right sensor is malfunctioning based on the test code.\n")
        ...
        if(cond == 0):
            ...
            if(trust == 0):    
                tts.say("Please take over. The front right sensor is malfunctioning based on the test code.")  
            else:
                tts.say("Please take over. The front right sensor is malfunctioning based on the test code.")
