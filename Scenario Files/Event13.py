...
def main():
    ...
    if(robot == 0):
        ...
        if(cond == 0):
            ...
            if(trust == 0):    
                sock.send("Speak Please take over. There is an error in ")
                sock.send("the system's decision making code.\n")
            else:
                sock.send("Speak Please take over. There is an error in ")
                sock.send("the system's decision making code.\n")
        ...
        if(cond == 0):
            ...
            if(trust == 0):    
                tts.say("Please take over. There is an error in the system's decision making code.")  
            else:
                tts.say("Please take over. There is an error in the system's decision making code.")
    return 0.0
